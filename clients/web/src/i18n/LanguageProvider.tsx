...
import { clearTenantTimezone, setTenantTimezone } from '../utils/tenantDate';
...
export const LanguageProvider: React.FC<{ children: unknown }> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        ...
        setTenantTimezone(prefs?.timezone);
        if (isActive) {
